...
#couleur
is_red = True #variable utilisé pour le changement de couleur
...
while not Termine:
  ...
  if balle_y > TailleEcran[1] or balle_y < 0:
    ...
    is_red = not is_red #changement couleur
  if balle_x > TailleEcran[0] or balle_x < 0:
    balle_change_x = balle_change_x * -1
    is_red = not is_red #changement color
  ...
  pygame.draw.circle(screen,BLACK,[balle_x,balle_y],balle_rayon *2)
  pygame.draw.circle(screen,RED if is_red else GREEN,[balle_x,balle_y],balle_rayon )
